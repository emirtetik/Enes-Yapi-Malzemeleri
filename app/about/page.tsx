...
const page = () => {
  return (
    <div>
      <ContactIcons/>
      <div className={`lg:flex flex-wrap  sm:grid`}>
   <section className=' lg:m-10 lg:max-w-xs sm:max-w-none sm:m-0'>
   ...
   <section className={`flex flex-grow ${styles.flex_container}`}>
  <div className="container px-5 py-12 ">
    <div className="flex relative pt-10 pb-20 sm:items-center md:w-3/3 mx-auto">
    ...
    <div className="flex relative pb-20 sm:items-center md:w-3/3 mx-auto">
      <div className="h-full w-6 absolute inset-0 flex items-center justify-center">
        <div className="h-full w-1 bg-gray-200 pointer-events-none"></div>
      </div>
    ...
    <div className="flex relative pb-20 sm:items-center md:w-3/3 mx-auto">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <h2 className="font-medium title-font text-red-500 mb-1 text-xl">Vizyonumuz</h2>
          <p className="leading-relaxed">VHS cornhole pop-up, try-hard 8-bit iceland helvetica. Kinfolk bespoke try-hard cliche palo santo offal.</p>
        </div>
      </div>
    </div>
    <div className="flex relative pb-10 sm:items-center md:w-3/3 mx-auto">
      <div className="h-full w-6 absolute inset-0 flex items-center justify-center">
        <div className="h-full w-1 bg-gray-200 pointer-events-none"></div>
      </div>
