...
const Footer = () => {
      ...
      <div className="w-full px-4 lg:w-1/4 md:w-1/2">
        ...
        <div className="flex flex-wrap items-end justify-center xl:flex-nowrap md:flex-nowrap lg:flex-wrap md:justify-start">
          <div className="relative w-40 mr-2 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4">
            ...
            <input type="text" id="footer-field" name="footer-field" className="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:bg-transparent focus:ring-2 focus:ring-red-200 focus:border-red-500"/>
          </div>
          <button className="inline-flex flex-shrink-0 px-6 py-2 text-white bg-red-500 border-0 rounded lg:mt-2 xl:mt-0 focus:outline-none hover:bg-red-600">Button</button>
        </div>
        <p className="mt-2 text-sm text-center text-gray-500 md:text-left">Bitters chicharrones fanny pack
  ...
  <div className="bg-gray-100">
    <div className="container flex flex-col items-center px-5 py-6 mx-auto sm:flex-row">
      ...
      <p className="mt-4 text-sm text-gray-500 sm:ml-6 sm:mt-0">© 2020 Tailblocks —
        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="ml-1 text-gray-600" target="_blank">@knyttneve</a>
      </p>
